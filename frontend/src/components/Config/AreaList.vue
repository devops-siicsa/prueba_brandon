    ...
    <div :class="[isMobileDevice ? 'px-4 py-3' : 'px-6 py-4', 'd-flex justify-space-between align-center bg-white border-b']">
      <div class="d-flex align-center">
          <div class="header-icon-box mr-4" :style="isMobileDevice ? 'width: 36px; height: 36px;' : ''">
              <v-icon color="primary" :size="isMobileDevice ? 20 : 24">mdi-chart-tree</v-icon>
          </div>
          <div>
              <h2 :class="[isMobileDevice ? 'text-subtitle-1' : 'text-h6', 'font-weight-bold text-grey-darken-3 mb-1']">Gestión de Áreas</h2>

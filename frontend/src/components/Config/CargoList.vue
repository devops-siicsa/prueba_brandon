    ...
    <div :class="[isMobileApp ? 'px-4 py-3' : 'px-6 py-4', 'd-flex justify-space-between align-center bg-white border-b']">
      <div class="d-flex align-center">
          <div class="header-icon-box mr-4" :style="isMobileApp ? 'width: 36px; height: 36px;' : ''">
              <v-icon color="primary" :size="isMobileApp ? 20 : 24">mdi-badge-account</v-icon>
          </div>
          <div>
              <h2 :class="[isMobileApp ? 'text-subtitle-1' : 'text-h6', 'font-weight-bold text-grey-darken-3 mb-1']">Gestión de Cargos</h2>

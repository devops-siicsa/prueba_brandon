                    ...
                    <v-row dense>
                        <v-col cols="12">
                            ...
                            <v-autocomplete
                                ...
                                :readonly="!isEditing"
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-select' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-microsoft-windows' : undefined"
                        ...
                        <v-col cols="12" v-if="!isLinuxOrMac" class="mt-4">
                            ...
                            <v-text-field
                                ...
                                :readonly="!isEditing"
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-key-variant' : undefined"
                        ...
                        <v-col cols="12" v-if="isLinuxOrMac" class="mt-4">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-linux' : undefined"
                                @update:model-value="$emit('update', 'LicenciaSO', $event)"
                                :rules="[v => !!v || ' ']"
                            ></v-text-field>
                        </v-col>
                    ...
                    <v-row dense>
                        <v-col cols="12">
                            ...
                            <v-autocomplete
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-select' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-file-document-multiple' : undefined"
                        ...
                        <v-col cols="12" v-if="!isOfficeFree" class="mt-4">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-account-key' : undefined"
                        ...
                        <v-col cols="12" v-if="isOfficeFree" class="mt-4">
                             ...
                             <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-package-variant' : undefined"
                                @update:model-value="$emit('update', 'LicenciaOfimatica', $event)"
                                :rules="[v => !!v || ' ']"
                            ></v-text-field>
                        </v-col>
                    ...
                    <v-row dense>
                        ...
                        <v-col cols="12" md="4">
                            ...
                            <v-autocomplete
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-select' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-domain' : undefined"
                        ...
                        <v-col cols="12" md="4">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-server-network' : undefined"
                        ...
                        <v-col cols="12" md="4">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-desktop-tower' : undefined"
                        ...
                        <v-col cols="12" md="4" class="mt-4">
                            ...
                            <v-autocomplete
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-select' : '', isEditing ? 'mb-3' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-shield-check' : undefined"

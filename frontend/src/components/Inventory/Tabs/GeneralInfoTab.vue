                    ...
                    <v-row dense>
                        <v-col cols="12" md="6">
                            ...
                            <v-text-field
                                ...
                                :prepend-inner-icon="isEditing ? 'mdi-barcode' : undefined"
                                :append-inner-icon="isEditing ? (isMobileApp ? 'mdi-qrcode-scan' : undefined) : undefined"
                                :rules="[v => !!v || ' ']"
                        ...
                        <v-col cols="12" md="6">
                            ...
                            >
                                <template v-slot:prepend-inner>
                                    <v-icon v-if="isEditing" :color="statusIconColor">mdi-heart-pulse</v-icon>
                                </template>
                            </v-select>
                        </v-col>
                        ...
                        <v-col cols="12" md="6" class="mt-4">
                            ...
                            <v-select
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-select' : '', isEditing ? '' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-devices' : undefined"
                                :rules="[v => !!v || ' ']"
                        ...
                        <v-col cols="12" md="6" class="mt-4" v-if="!isClon">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? '' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-tag-text-outline' : undefined"
                                :rules="[v => !!v || ' ']"
                        ...
                        <v-col cols="12" md="6" class="mt-4" v-if="!isClon">
                            ...
                            <v-text-field
                                ...
                                hide-details="auto"
                                :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? '' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                :prepend-inner-icon="isEditing ? 'mdi-fingerprint' : undefined"
                                :append-inner-icon="isEditing ? (photoPreview ? 'mdi-paperclip' : 'mdi-camera') : undefined"
                        ...
                        <template v-if="!equipo.EsPropio">
                            <v-col cols="12" md="4">
                                ...
                                <v-text-field
                                    ...
                                    hide-details="auto"
                                    :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? '' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                    :prepend-inner-icon="isEditing ? 'mdi-store' : undefined"
                                    :rules="[v => !!v || ' ']"
                            ...
                            <v-col cols="12" md="4">
                                ...
                                <v-text-field
                                    ...
                                    hide-details="auto"
                                    :class="['rounded-xl', isEditing && modern ? 'modern-input' : '', isEditing ? '' : 'pa-0', isMobileApp ? 'mobile-input' : '']"
                                    :prepend-inner-icon="isEditing ? 'mdi-file-document-outline' : undefined"
                                    :rules="[v => !!v || ' ']"
